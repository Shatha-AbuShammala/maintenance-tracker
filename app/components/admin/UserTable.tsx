              ...
              <tr key={user._id} className="transition hover:bg-slate-50">
                ...
                <td className="whitespace-nowrap px-6 py-4 text-right">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-md border border-red-200 px-3 py-2 text-xs font-semibold text-red-700 shadow-sm transition hover:bg-red-50 cursor-pointer"
